...
[![React 18](https://img.shields.io/badge/React-18.3-20232A?style=for-the-badge&logo=react&logoColor=61DAFB)](https://react.dev/)
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/aadityashekhar321/nutrilens)

<br />

<a href="#-core-diagnostic-engines">
  <img src="./public/images/banner.jpg" alt="NutriLens Intelligence Engine Banner" width="100%" style="border-radius: 16px; border: 1px solid rgba(255,255,255,0.15); box-shadow: 0 25px 50px -12px rgba(0,0,0,0.85);" />
</a>
...
<img src="./public/images/truth_scanner.jpg" alt="NutriLens Food Truth Scanner HUD" width="100%" style="border-radius: 16px; border: 1px solid rgba(255,255,255,0.12); box-shadow: 0 24px 48px -12px rgba(0,0,0,0.8);" />
